...
//                   >
//                     {/* Avatar */}
//                     <img src={user.photo} className="user__img" alt="User Avatar" />

//                     {/* Dropdown Menu */}
//                     {dropdownOpen && (
//                       <div className="dropdown__menu">
//                         <h5 className="mb-0">{user.username}</h5>
//                         <Link to="/profile" className="dropdown__item">Profile</Link>
//                         <Link to="/settings" className="dropdown__item">Settings</Link>
//                         <Button className="btn btn-dark dropdown__item" onClick={logout}>
//                           Logout
//                         </Button>
//                       </div>
//                     )}
